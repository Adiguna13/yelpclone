...
async function seedPlaces() {
  const places = [
    {
      ...
      image: "http://source.unsplash.com/collection/1319040/500x500",
    },
    {
      title: "Pantai Kuta",
      price: "0",
  ...
  try {
    const newPlace = places.map((place) => {
      return { ...place, author: "65064f5669aa4c4a1c52eb2c", images: {
        url: "public\\images\\image-1695128750641-151017310.jpg",
        filename: 'image-1695128750641-151017310.jpg'
      } };
    });
